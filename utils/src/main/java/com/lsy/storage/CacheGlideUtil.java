/*
 * Created by lsy on 2018/8/21.
 * Copyright (c) 2018 yeeyuntech. All rights reserved.
 */
 ...
 * Glide缓存工具类
 */
public class CacheGlideUtil {
    private static CacheGlideUtil inst;

    public static CacheGlideUtil getInstance() {
        if (inst == null) {
            inst = new CacheGlideUtil();
        }
        return inst;
    }
